...
- `scripts/security_smoke.js`: 37 assertions, including a concrete Tang-dynasty Li Bai ink-wash visual bible whose melancholic-to-hopeful palette, lighting, composition, ID and prompt prefix are derived from the brief, plus zero-call 33tc `pick/cut` confirmation gates and structured credential/URL output redaction.
